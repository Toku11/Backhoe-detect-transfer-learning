...
``` bash
#From /Skycatch
sh autostart.sh or open autostart.sh and copy line by line the commands
```
...
sudo nano .bashrc " export PYTHONPATH="${PYTHONPATH}:/home/{username}/Skycatch/models/research/:/home/{username}/Skycatch/models/research/slim/" " or run from every new terminal you start.
```
NOTE:
...
* Download the checkpoint data by clicking in the file at GCP/{your_bucket}, move to /Skycatch/data and run the following:
