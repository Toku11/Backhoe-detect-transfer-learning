...
## code to create .record dataset from csv and images
...
# class to clasify, number 4 to avoid erros because the dataset have anothers classes.
def class_text_to_int(row_label):
    if row_label == 'body':
        return 1
    elif row_label=='hoe':
        return 2
    elif row_label=='wheels':
        return 3
    else:
        return 4
